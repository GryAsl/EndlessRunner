...
#include "EndlessRunnerOffroadCar.h"
#include "EndlessRunnerOffroadWheelFront.h"
#include "EndlessRunnerOffroadWheelRear.h"
...
AEndlessRunnerOffroadCar::AEndlessRunnerOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UEndlessRunnerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UEndlessRunnerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UEndlessRunnerOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UEndlessRunnerOffroadWheelRear::StaticClass();
