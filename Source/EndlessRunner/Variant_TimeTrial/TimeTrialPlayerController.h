...
class UEndlessRunnerUI;
class AEndlessRunnerPawn;
...
protected:
	...
	TSubclassOf<UEndlessRunnerUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UEndlessRunnerUI> VehicleUI;
	...
	TSubclassOf<AEndlessRunnerPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AEndlessRunnerPawn> VehiclePawn;
